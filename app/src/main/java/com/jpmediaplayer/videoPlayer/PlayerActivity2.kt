...
import com.jpmediaplayer.videoPlayer.databinding.ActivityPlayer2Binding
import com.jpmediaplayer.videoPlayer.databinding.AudioBoosterBinding

class PlayerActivity2 : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
...
//Important Function
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "MusicAdapterSearch"-> initServiceAndPlaylist(MainActivity2.musicListSearch, shuffle = false)
            "MusicAdapter" -> initServiceAndPlaylist(MainActivity2.MusicListMA, shuffle = false)
            "FavouriteAdapter"-> initServiceAndPlaylist(FavouriteActivity.favouriteSongs, shuffle = false)
            "MainActivity2"-> initServiceAndPlaylist(MainActivity2.MusicListMA, shuffle = true)
    ...
    private fun setLayout(){
        ...
        val image = if (img != null) {
            ...
            BitmapFactory.decodeResource(
                resources,
                R.mipmap.ic_video_player_foreground
            )
        }
    ...
    private fun showBottomSheetDialog(){
        val dialog = BottomSheetDialog(this@PlayerActivity2)
