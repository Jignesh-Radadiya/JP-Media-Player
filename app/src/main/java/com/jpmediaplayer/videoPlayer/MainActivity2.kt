...
import com.jpmediaplayer.videoPlayer.cloude.LoginActivity
import com.jpmediaplayer.videoPlayer.databinding.ActivityMain2Binding
import java.io.File
...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shuffleBtn.setOnClickListener {
            val intent = Intent(this@MainActivity2, PlayerActivity2::class.java)
            intent.putExtra("index", 0)
            intent.putExtra("class", "MainActivity2")
            startActivity(intent)
        }
        binding.favouriteBtn.setOnClickListener {
            startActivity(Intent(this@MainActivity2, FavouriteActivity::class.java))
        }
        binding.playlistBtn.setOnClickListener {
            startActivity(Intent(this@MainActivity2, PlaylistActivity::class.java))
        }
        binding.playNextBtn.setOnClickListener {
            startActivity(Intent(this@MainActivity2, PlayNext::class.java))
        }
        binding.bottomNav1.setOnItemSelectedListener {
            when (it.itemId) {
                R.id.videoView1 -> startActivity(Intent(this , com.jpmediaplayer.videoPlayer.MainActivity::class.java))
//                R.id.button2 ->
...
//                R.id.navFeedback -> startActivity(Intent(this@MainActivity, FeedbackActivity::class.java))
                R.id.navSettings -> startActivity(Intent(this@MainActivity2, SettingsActivity::class.java))
                R.id.navAbout -> startActivity(Intent(this@MainActivity2, AboutActivity::class.java))
                R.id.cloud -> startActivity(Intent(this, LoginActivity::class.java))
//                R.id.navExit -> {
...
//                }
    ...
    private fun initializeLayout(){
        ...
        musicAdapter = MusicAdapter(this@MainActivity2, MusicListMA)
    ...
    override fun onDestroy() {
        super.onDestroy()
        if(!PlayerActivity2.isPlaying && PlayerActivity2.musicService != null){
            exitApplication()
        }
    }
    ...
    override fun onResume() {
        ...
        if(PlayerActivity2.musicService != null) binding.nowPlaying.visibility = View.VISIBLE
    }
