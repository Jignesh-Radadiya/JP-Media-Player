...
import com.jpmediaplayer.videoPlayer.databinding.FavouriteViewBinding
        ...
        if(playNext){
            ...
            holder.root.setOnLongClickListener {
                ...
                bindingMF.AddToPNBtn.setOnClickListener {
                    if(position == PlayerActivity2.songPosition)
                        ...
                        if(PlayerActivity2.songPosition < position && PlayerActivity2.songPosition != 0) --PlayerActivity2.songPosition
                        PlayNext.playNextList.removeAt(position)
                        PlayerActivity2.musicListPA.removeAt(position)
